...
Proof. intros pi. apply (ex_transp_middle1 nil), bot_r, pi. Defined.
...
Proof.
intros. apply (ex_transp_middle1 nil), with_r; apply (ex_transp_middle2 nil); assumption.
Defined.

Lemma plus_r1_ext l1 A B l2 : ll (l1 ++ A :: l2) -> ll (l1 ++ aplus A B :: l2).
Proof. intros pi. apply (ex_transp_middle1 nil), plus_r1, (ex_transp_middle2 nil), pi. Defined.

Lemma plus_r2_ext l1 A B l2 : ll (l1 ++ A :: l2) -> ll (l1 ++ aplus B A :: l2).
Proof. intros pi. apply (ex_transp_middle1 nil), plus_r2, (ex_transp_middle2 nil), pi. Defined.
...
clear. induction l1 as [|? ? IHl1]; cbn; [ | rewrite IHl1 ]; reflexivity.
Defined.

Lemma de_r_ext l1 A l2 : ll (l1 ++ A :: l2) -> ll (l1 ++ wn A :: l2).
Proof. intros pi. apply (ex_transp_middle1 nil), de_r, (ex_transp_middle2 nil), pi. Defined.

Lemma wk_r_ext l1 A l2 : ll (l1 ++ l2) -> ll (l1 ++ wn A :: l2).
Proof. intros pi. apply (ex_transp_middle1 nil), wk_r, pi. Defined.

Lemma co_r_ext l1 A l2 : ll (l1 ++ wn A :: wn A :: l2) -> ll (l1 ++ wn A :: l2).
Proof.
intros pi.
apply (ex_transp_middle1 nil), co_r.
apply (ex_transp_middle2 (wn A :: nil)), (ex_transp_middle2 nil l1), pi.
Defined.
